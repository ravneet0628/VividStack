...
export const services = [
  {
    ...
    tagline: "One page for launches, campaigns, or a simple first site.",
    highlight: false,
    features: [
      "Hero, services, proof, and contact on one page",
      "Responsive layout and type for phone and desktop",
      "SEO-ready structure and meta tags",
      "Contact form or main CTA, wired and tested",
      "Business email setup; hosting included",
      "Launch checklist and walkthrough",
    ],
  },
  {
    id: "multi-page",
    name: "Multi-page site",
    tagline: "Full small-business site with room to grow—no CMS required yet.",
    highlight: true,
    features: [
      "Multiple pages tailored to your business",
      "One visual system and consistent components sitewide",
      "Titles, descriptions, and internal links set up for SEO",
      "Contact form or main CTA, wired and tested",
      "Business email setup; hosting included",
      "Launch checklist and walkthrough",
    ],
  },
  {
    id: "site-cms",
    name: "Site + CMS",
    tagline: "Update copy, pages, or posts often—without calling a developer.",
    highlight: false,
    features: [
      "Everything in multi-page, plus easy updates for you or your team",
      "Custom content types (pages, posts, repeats) for your workflow",
      "Walkthrough and notes to keep content fresh",
      "Draft and publish tools tuned to how you work",
    ],
  },
];
